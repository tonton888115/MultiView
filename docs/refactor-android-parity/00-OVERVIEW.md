...
- **残(任意・polish)**: 2C-NetInfo(wifi/mobile検出、新規依存要)、2E YouTube WebView軽量化、3D 効果音(`giftSoundEnabled`)＋iOS級リッチ演出、Phase 4の全プラットフォーム網羅テスト、Kick/Twitch/TwitCasting ライブ実機検証。
